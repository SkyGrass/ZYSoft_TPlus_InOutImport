...
using Chanjet.ZYSoft.InOutImport.Interface;
using Ufida.T.EAP.Aop;
using Ufida.T.EAP.DataStruct.Context;
using System.Web;
using Ufida.T.EAP.Dal;

namespace Chanjet.ZYSoft.InOutImport.UIP
{
    public class InOutImportPage : IAppHandler
    {
        GenericController controller;
        IInOutImport interfaceService;
        Label lblUserName;
        Label lbUserId;
        Label lbUserCode;
        public void AppEventHandler(object sender, AppEventArgs e)
        {
            ...
            interfaceService = ServiceFactory.getService<IInOutImport>();
